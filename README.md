...
This repository is created as a base repository that represent the base architecture for every project that will be created onwards. 
Everyone needs to follow this architecture everytime a new project is assigned.
